...
# GRUB Theme Installer (originally from Chris Titus Tech)
#
# Note: Despite the filename "sddm-theme.sh", this script is for installing
# GRUB themes, not SDDM themes.
#
# It offers several popular themes (Vimix, Cyberpunk, Shodan, etc.).
#
# @license MIT
